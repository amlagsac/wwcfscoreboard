              ...
              <Grid container>
                <Grid item xl={12} lg={12} md={12} sm={12} xs={12} display={"flex"}>
                {
                  ...
                  <Box sx={{ px: 8, mx: "auto", border: 1, borderColor: "white", borderWidth: 5, borderTop: "none", borderRadius: 2}} justifyContent="center" alignContent="center" display={"flex"} bgcolor={'#000000'}>
                    <Typography className="red_shadow" variant="h2" sx={{ fontFamily: "digital-7", fontSize: { xs: "9rem", sm: "10rem", md: "11rem", lg: "12rem", xl: "13rem" }, color: "red"}}>{minutes}</Typography>
                    <Typography className="red_shadow" variant="h2" sx={{ fontFamily: "digital-7", fontSize: { xs: "9rem", sm: "10rem", md: "11rem", lg: "12rem", xl: "13rem" }, color: "red"}}>:</Typography>
                    <Typography className="red_shadow" variant="h2" sx={{ fontFamily: "digital-7", fontSize: { xs: "9rem", sm: "10rem", md: "11rem", lg: "12rem", xl: "13rem" }, color: "red"}}>{(seconds <= 9 ? "0" : "") + seconds}</Typography>
                  </Box>
                  {
                    changeCourt
                    ?
                ...
                <Grid item xl={4} lg={4} md={4} sm={4} xs={12} sx={{ mt: 4 }}>
                  ...
                  <Typography variant="h3" sx={{ color: "#FFFFFF", fontWeight: 900}}>SHOT CLOCK</Typography>
                    <Box sx={{ mx: "auto", display: "flex", justifyContent: "center" }}>
                    <Typography className="orange_shadow" variant="h1" sx={{backgroundColor: "#000000", fontFamily: "digital-7", color: "#FFA500", px: 3, fontSize: { xs: "8rem", sm: "9rem", md: "10rem", lg: "11rem", xl: "12rem" }, border: 1, borderColor: "white", borderWidth: 1, borderRadius: 2}}>{shotClockSeconds}</Typography>
                    </Box> 
                  </Box>
                </Grid>
                <Grid item xl={4} lg={4} md={4} sm={4} xs={12} sx={{ mt: 4 }}>
                  <Box textAlign="center">
                    ...
                    <Box sx={{ mx: "auto", display: "flex", justifyContent: "center" }}>
                      <Typography className="green_shadow" variant="h1" sx={{backgroundColor: "#000000", fontFamily: "digital-7", color: "#2CE71E", fontSize: { xs: "8.5rem", sm: "9.5rem", md: "10.5rem", md: "10.5rem", lg: "11.5rem", xl: "12.5rem" }, px: 3.5, border: 1, borderColor: "white", borderWidth: 1, borderRadius: 2 }}>{changeCourt ? (lightScore <= 9 ? "0" : "") + lightScore : (darkScore <= 9 ? "0" : "") + darkScore}</Typography>
                    </Box>
                  </Box>
                </Grid>
                <Grid item xl={2.4} lg={2.4} md={6} sm={6} xs={6} sx={{ mt: 4, mb: .5}}>
                  <Box textAlign="center">
                    ...
                    <Box sx={{ mx: "auto", display: "flex", justifyContent: "center" }}>
                      <Typography className="red_shadow" variant="h1" sx={{backgroundColor: "#000000", fontFamily: "digital-7", color: "red", fontSize: { xs: "3.5rem", sm: "4.5rem", md: "5.5rem", lg: "6.5rem", xl: "7.5rem" }, px: 2.5, border: 1, borderColor: "white", borderWidth: 1, borderRadius: 2 }}>{changeCourt ? timeoutDark : timeoutLight}</Typography>
                    </Box>
                  </Box>
                </Grid>
                ...
                <Box textAlign="center">
                    ...
                    <Box sx={{ mx: "auto", display: "flex", justifyContent: "center" }}>
                    <Typography className="red_shadow" variant="h1" sx={{backgroundColor: "#000000", fontFamily: "digital-7", color: "red", fontSize: { xs: "3.5rem", sm: "4.5rem", md: "5.5rem", lg: "6.5rem", xl: "7.5rem" }, px: 2.5, border: 1, borderColor: "white", borderWidth: 1, borderRadius: 2, textAlign: "center" }}>{changeCourt ? (foulDark < 5 ? foulDark : "P")  : (foulLight < 5 ? foulLight : "P")}</Typography>
                    </Box>
                  </Box>
                </Grid>
                ...
                <Box textAlign="center">
                    ...
                    <Box sx={{ mx: "auto", display: "flex", justifyContent: "center" }}>
                    <Typography className="red_shadow" variant="h1" sx={{backgroundColor: "#000000", fontFamily: "digital-7", color: "#FFA500", fontSize: { xs: "3.5rem", sm: "4.5rem", md: "5.5rem", lg: "6.5rem", xl: "7.5rem" }, px: 6, border: 1, borderColor: "white", borderWidth: 1, borderRadius: 2, textAlign: "center" }}>{quarter === "5" ? "OT" : quarter}</Typography>
                    </Box>
                  </Box>
                </Grid>
                <Grid item xl={2.4} lg={2.4} md={6} sm={6} xs={6} sx={{ mt: 4 }}>
                <Box textAlign="center">
                    <Typography variant="h3" sx={{ color: "#FFFFFF", fontWeight: 600}}>FOULS</Typography>
                    <Box sx={{ mx: "auto", display: "flex", justifyContent: "center" }}>
                      <Typography className="red_shadow" variant="h1" sx={{backgroundColor: "#000000", height: "inherit", fontFamily: "digital-7", color: "red", fontSize: { xs: "3.5rem", sm: "4.5rem", md: "5.5rem", lg: "6.5rem", xl: "7.5rem" }, px: 2.5, border: 1, borderColor: "white", borderWidth: 1, borderRadius: 2, textAlign: "center" }}>{changeCourt ? (foulLight < 5 ? foulLight : "P")  : (foulDark < 5 ? foulDark : "P")}</Typography>
                    </Box>
                  </Box>
                </Grid>
                <Grid item xl={2.4} lg={2.4} md={6} sm={6} xs={6} sx={{ mt: 4 }}>
                <Box textAlign="center">
                    <Typography variant="h3" sx={{ color: "#FFFFFF", fontWeight: 600}}>TOL</Typography>
                    <Box sx={{ mx: "auto", display: "flex", justifyContent: "center" }}>
                      <Typography className="red_shadow" variant="h1" sx={{backgroundColor: "#000000", height: "inherit", fontFamily: "digital-7", color: "red", fontSize: { xs: "3.5rem", sm: "4.5rem", md: "5.5rem", lg: "6.5rem", xl: "7.5rem" }, px: 2.5, border: 1, borderColor: "white", borderWidth: 1, borderRadius: 2 }}>{changeCourt ? timeoutLight : timeoutDark}</Typography>
                    </Box>
                  </Box>
                </Grid>
              </Grid>
